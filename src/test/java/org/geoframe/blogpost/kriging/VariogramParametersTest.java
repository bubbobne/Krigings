...
public class VariogramParametersTest {
    ...
    public void testConstructorWithString() {
        // Create an instance using the constructor with (String, double, double, double)
        VariogramParameters vp = new VariogramParameters("exponential", 0.1, 100.0, 150.0);
        ...
        // Since parameters are non-negative and modelName is not null, isValid() should return true.
    ...
    public void testConstructorWithDouble() {
        ...
        VariogramParameters vp = new VariogramParameters(1.0, 0.2, 120.0, 180.0);
    ...
    public void testToHashMapWithValidModel() {
        ...
        VariogramParameters vp = new VariogramParameters("spherical", 0.5, 80.0, 130.0);
        // Set flags for local and trend
        vp.setIsLocal(true);
        vp.setIsTrend(true);
        ...
        // Expected mapping:
        // 0 -> nugget, 1 -> sill, 2 -> range, 3 -> isLocal flag (0.0 if true, else 1.0),
    ...
    public void testIsValid() {
        ...
        VariogramParameters vpValid = new VariogramParameters("linear", 0.0, 50.0, 75.0);
        assertTrue(vpValid.isValid());

        // Instance with a negative nugget should be invalid.
        VariogramParameters vpNeg = new VariogramParameters("linear", -1.0, 50.0, 75.0);
        assertFalse(vpNeg.isValid());

        // Instance with a null modelName should be invalid.
        VariogramParameters vpNull = new VariogramParameters(null, 0.0, 50.0, 75.0);
