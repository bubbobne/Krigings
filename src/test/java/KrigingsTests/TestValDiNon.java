...
public class TestValDiNon {
	...
	public void testKrigingSic97WithTrend() throws URISyntaxException, SchemaException, CQLException, IOException {
		...
		File stazioniGridFile = new File(
				"/home/andreisd/Desktop/OMS_Project_Brenta ERMKrig copia/OMS_Project_Brenta ERMKrig copia/data/Brenta/MeteoStations.shp");
		...
		reader.file = "/home/andreisd/Desktop/OMS_Project_Brenta ERMKrig copia/OMS_Project_Brenta ERMKrig copia/data/Brenta/Precipitations.csv";
		reader.idfield = "ID";
		reader.tStart = "2012-03-15 01:00";
		reader.tTimestep = 60;
